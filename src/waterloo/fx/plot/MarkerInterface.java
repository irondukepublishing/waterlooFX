...
/**
 * MarkerInterface is implemented by subclasses that make use of the marker
 * properties in the VisualModel.
 *
 * The CssMetaData return false from isSettable on marker properties if this
